...
enum MQTTAppError: LocalizedError {

    case accessDenied
    case accessRestricted
    case failedReadingReminders
    case reminderHasNoDueDate
    case eventHasNoStartOrEndDate
    case unknown
    ...
    var errorDescription: String? {
        ...
        case .eventHasNoStartOrEndDate:
                    return NSLocalizedString(
                        "A event has no start or end date.", comment: "event has no start or end date error description")
        case .unknown:
